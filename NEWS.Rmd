...
*GetGhcn: Get GHCN data for specified siteIds.

*GetGhcn2: Get GHCN data for specified siteIds.

*GetTimeZone: Return the time zone for gauge locations.

*timeZone: Polygon shapefile of world time zone classification.
