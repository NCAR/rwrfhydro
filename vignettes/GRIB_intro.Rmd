...
```{r}
fileIn <- '~/wrfHydroTestCases/Fourmile_Creek_Regrid_Testcase/HRRR/hrrr.t12z.wrfnatf00_testcase.grib2'
var <- '2t'
...
files are broken up by forecast times. If you are unsure though, there is a tool
to determine this. 
```{r}
