...
Now limit the plot to the May through June snowmelt period. Note that the reported stats are also updated to the new time period.
```{r compFluxesJune, fig.width = 12, fig.height = 6, out.width='700', out.height='350'}
PlotFluxCompare(obsFlux1d.usnr1, "LE", modLdasout.allrt.niw, "LE", 
                labelObs="Observed Niwot Ameriflux", labelMod1="All Routing", 
                title="ET: Niwot Ridge",  
