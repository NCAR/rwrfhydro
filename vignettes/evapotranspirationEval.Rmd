...
vignette: >
  %\VignetteIndexEntry{Evaluate evapotranspiration simulation with rwrfhydro}
...
```{r}
ldasoutFilesList <- list( ldasout = list.files(path=paste0(dataPath, '/RUN.RTTESTS/OUTPUT_ALLRT'), 
