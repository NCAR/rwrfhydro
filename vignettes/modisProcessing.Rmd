...
MODISoptions(localArcPath="~/wrfHydroTestCases/MODIS_ARC", outDirPath="~/wrfHydroTestCases/MODIS_ARC/PROCESSED", gdalPath=gdalPath)
```
...
legend("topleft", c("MODIS Raw", "Smooth Filter 1", "Smooth Filter 2"), col=c("black", "red", "blue"), lty=c(1,1,1))
```
