...
```{r, fig.width = 12, fig.height = 9, out.width='700', out.height='525'}
# set your own path
...
```{r precipDoubleRun, fig.width = 12, fig.height = 6, out.width='700', out.height='350'}
...
Plot it by order
```{r orderPlot, fig.width = 12, fig.height = 9, out.width='700', out.height='525'}
