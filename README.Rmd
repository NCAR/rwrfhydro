...
=================
  ...
  * [Developing](#developing)
    ...
    * [Workflow: git, R packaging, and you](#git, R Packaging, and you)
...
We give more details on using git in the workflow overview below.
...
* Development cycles:
  ...
  * Merge your devBranch with your master. (`git check out devBranch; git merge master`)
