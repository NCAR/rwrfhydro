...
## Developing
There are three main aspects of develop the code base and contributing:
...
### Forking and cloning.
Please fork the repository to contribute. A fork is a separate copy of the repository. You then clone 
