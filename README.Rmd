...
For thematic and in-depth overviews into rwrfhydro functionality, check out the [online vignettes](https://github.com/mccreigh/rwrfhydro/blob/master/vignettes.Rmd) (or in R `browseVignettes("rwrfhydro")`).
