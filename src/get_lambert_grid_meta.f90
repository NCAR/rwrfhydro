...
subroutine get_lambert_grid_meta(len1,fileIn,nx,ny,dx,dy,lat1,lon1,lonv, &
                                 latd,latin1,latin2,snFlag,iret)
...
integer, intent(inout)      :: dx
integer, intent(inout)      :: dy
real*8, intent(inout)       :: lat1
real*8, intent(inout)       :: lon1
real*8, intent(inout)       :: lonv
real*8, intent(inout)       :: latd
real*8, intent(inout)       :: latin1
real*8, intent(inout)       :: latin2
